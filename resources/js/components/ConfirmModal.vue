<template>
    <Teleport to="body">
        <div v-if="show"
            ...
            <div
                class="relative mx-auto p-6 border w-full max-w-md shadow-2xl rounded-xl bg-white dark:bg-gray-800 transform transition-all">
                <!-- Icon -->
                ...
                <!-- Message -->
                <p class="text-sm text-center text-gray-600 dark:text-gray-400 mb-6" v-html="message"></p>
                ...
                <div class="flex gap-3">
                    ...
                    <button type="button" @click="handleConfirm" :disabled="loading" :class="confirmButtonClasses">
