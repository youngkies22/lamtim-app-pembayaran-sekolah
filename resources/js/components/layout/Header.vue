<template>
  <header class="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-3">
            <div v-if="appSettings.logo_aplikasi" class="w-10 h-10 rounded-lg overflow-hidden flex items-center justify-center flex-shrink-0 bg-white dark:bg-gray-700 p-1 border border-gray-200 dark:border-gray-600">
              <img 
            ...
            <div v-else class="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center shadow-md">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="relative" ref="dropdownRef">
            ...
            >
              <div v-if="currentUser?.avatar" class="w-8 h-8 rounded-full overflow-hidden border-2 border-indigo-500 flex-shrink-0">
                <img 
              ...
              <div v-else class="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-semibold text-sm">
