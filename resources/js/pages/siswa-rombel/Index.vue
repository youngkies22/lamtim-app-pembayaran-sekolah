          ...
          <table class="w-full text-sm">
            <thead class="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
              <tr>
                ...
                <th class="px-4 py-2.5 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Siswa</th>
                <th class="px-4 py-2.5 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">NIS</th>
                <th class="px-4 py-2.5 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Rombel</th>
                <th class="px-4 py-2.5 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Sekolah</th>
                <th class="px-4 py-2.5 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Jurusan</th>
              ...
              >
                ...
                <td class="px-4 py-2.5">
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      @click="handleDelete(mapping.id, mapping.siswa_nama)"
