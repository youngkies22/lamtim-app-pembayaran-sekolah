    ...
    <div class="space-y-6">
      ...
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-6 md:p-8 shadow-xl">
        ...
        <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p class="mt-2 text-indigo-100 text-sm md:text-base">Pilih siswa yang belum memiliki rombel dan mapping ke rombel yang dipilih</p>
          </div>
          <button
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <span class="text-sm text-gray-600 dark:text-gray-400">
                Terpilih: <strong class="text-indigo-600 dark:text-indigo-400">{{ selectedSiswaIds.length }}</strong> siswa
              </span>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button
              @click="handleBatchMapping"
              :disabled="!canMap || mappingLoading"
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div v-else>
          ...
          <!-- Pagination -->
          <div v-if="totalRecords > 0" class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <div class="text-sm text-gray-600 dark:text-gray-400">
              Menampilkan {{ (currentPage - 1) * perPage + 1 }} - {{ Math.min(currentPage * perPage, totalRecords) }} dari {{ totalRecords }} siswa
            </div>
            <div v-if="totalPages > 1" class="flex items-center gap-2">
              <button
                @click="currentPage = Math.max(1, currentPage - 1); loadUnmappedStudents()"
              ...
              <button
                @click="currentPage = Math.min(totalPages, currentPage + 1); loadUnmappedStudents()"
