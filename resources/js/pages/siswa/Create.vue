    ...
    <div class="space-y-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <!-- Validation Errors -->
          <div v-if="validationErrors && Object.keys(validationErrors).length > 0" class="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
...
const handleSubmit = async () => {
  try {
    ...
    toastRef.value?.success('Siswa berhasil ditambahkan');
    ...
    if (err.response?.status === 422) {
      ...
      formError.value = err.response?.data?.message || 'Gagal menambahkan siswa';
