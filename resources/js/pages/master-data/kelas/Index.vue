<template>
  <Layout :active-menu="'Master Data'">
        ...
        <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div class="flex items-center gap-3">
            ...
            <button
              ...
              class="group relative inline-flex items-center gap-2 px-6 py-3 bg-white text-green-600 font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
            >
          ...
          <table class="w-full">
            <thead>
              <tr class="bg-gray-50 dark:bg-gray-900/50">
                ...
                <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nama Kelas</th>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
              ...
              <tr v-else v-for="(item, index) in tableData" :key="item.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                ...
                <td class="px-6 py-4">
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center text-white font-semibold text-sm">
    ...
    <ConfirmModal
      ...
      type="danger"
      title="Hapus Kelas"
      :message="`Apakah Anda yakin ingin menghapus kelas '${deletingItem?.nama || ''}'?`"
