<template>
  <Layout :active-menu="'Master Data'">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
              ...
              <tr v-else v-for="(item, index) in tableData" :key="item.id"
                ...
                <td class="px-6 py-4">
                  <div class="flex items-center gap-3">
                    <div
                      class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white font-semibold text-sm">
    ...
    <!-- Form Modal -->
    <FormModal :show="showModal" :title="editingId ? `Edit ${labelJurusan}` : `Tambah ${labelJurusan} Baru`"
      ...
      <template #form>
        <div class="space-y-5">
          ...
          <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Nama {{ labelJurusan }}
              *</label>
    ...
    <ConfirmModal :show="showDeleteModal" type="danger" :title="`Hapus ${labelJurusan}`"
