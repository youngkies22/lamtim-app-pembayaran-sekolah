<template>
  <Layout :active-menu="'Master Data'">
    <div class="space-y-6">
      <!-- Header -->
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 p-8 shadow-xl">
    ...
    <FormModal
      :show="showModal"
      :title="editingId ? 'Edit Tipe Pembayaran' : 'Tambah Tipe Pembayaran Baru'"
        ...
        <div class="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-violet-500 dark:text-white"
              placeholder="Deskripsi tipe pembayaran"
            ></textarea>
          </div>
          <div>
    ...
    <InfoModal
      :show="showInfoModal"
      title="Informasi Tipe Pembayaran"
      subtitle="Pelajari lebih lanjut tentang tipe pembayaran yang bisa Anda isi"
