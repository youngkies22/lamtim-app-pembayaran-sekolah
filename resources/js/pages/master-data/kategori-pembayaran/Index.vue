<template>
  <Layout :active-menu="'Master Data'">
    <div class="space-y-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6">
        <div class="relative">
          ...
          <input type="text" v-model="searchQuery" @input="debouncedSearch" placeholder="Cari kategori pembayaran..."
    ...
    <!-- Form Modal -->
    <FormModal :show="showModal" :title="editingId ? 'Edit Kategori Pembayaran' : 'Tambah Kategori Pembayaran Baru'"
    ...
    <ConfirmModal :show="showDeleteModal" type="danger" title="Hapus Kategori Pembayaran"
    ...
    <!-- Info Modal -->
    <InfoModal :show="showInfoModal" title="Informasi Kategori Pembayaran"
      subtitle="Pelajari lebih lanjut tentang kategori pembayaran yang bisa Anda isi" :sections="infoSections"
